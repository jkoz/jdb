...
public class TTY implements EventNotifier {
    ...
    void printPrompt() {
        if (reader != null) {
            ...
            if (threadInfo == null) {
                reader.setPrompt(MessageOutput.format("jdb prompt with no current thread"));
            } else {
                reader.setPrompt(MessageOutput.format("jdb prompt thread name and current stack frame", new Object[] {
            ...
            if (Character.isDigit(cmd.charAt(0)) && t.hasMoreTokens()) {
                ...
                if (commandNumber < 0) {
                    ...
                    try {
                        ...
                        } else if (cmd.equals("eval") || cmd.equals("e")) {
                            evaluator.commandPrint(t, false);
                            showPrompt = false;        // asynchronous command
                        } else if (cmd.equals("set")) {
                            evaluator.commandSet(t);
                            showPrompt = false;        // asynchronous command
                        } else if (cmd.equals("dump") || cmd.equals("p")) {
                        ...
                        } else if (cmd.equals("cont") || cmd.equals("c")) {
                        ...
                        } else if (cmd.equals("clear") || cmd.equals("d")) {
    ...
    public TTY() throws Exception {
        ...
        try {
            ...
            reader = new ConsoleReader(System.in, new FilterOutputStream(System.out));
             ...
             */
            {
                ...
                reader.setHistory(new FileHistory(new File(userHome + File.separator + ".jdb_history")));
            }
